    ...
    return (
        <div className="carousel w-full">
            <div id="slide1" className="carousel-item relative w-full h-[600px]">
                ...
                <div className="absolute rounded-xl h-full flex items-center left-0  bottom-0 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]">
                    <div className='text-white space-y-4 w-1/2 pl-12'>
                        ...
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Veniam ducimus quos aut ipsam. Nesciunt quo vel inventore quod prov</p>
                        <div>
                ...
                <div className="absolute rounded-xl flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0">
                    <a href="#slide4" className="btn btn-circle bg-orange-400 mr-5">❮</a>
            ...
            <div id="slide2" className="carousel-item relative w-full h-[600px]">
                ...
                <div className="absolute rounded-xl flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0">
                    <a href="#slide1" className="btn btn-circle bg-orange-400 mr-5">❮</a>
            ...
            <div id="slide3" className="carousel-item relative w-full h-[600px]">
                ...
                <div className="absolute rounded-xl flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0">
                    <a href="#slide2" className="btn btn-circle bg-orange-400 mr-5">❮</a>
            ...
            <div id="slide4" className="carousel-item relative w-full h-[600px]">
                ...
                <div className="absolute rounded-xl flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0">
                    <a href="#slide3" className="btn btn-circle bg-orange-400 mr-5">❮</a>
